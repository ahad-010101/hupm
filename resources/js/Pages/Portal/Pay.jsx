                    ...
                    {owed <= 0 ? (
                        ...
                        <form onSubmit={submit} noValidate className="rounded-lg border border-gray-200 bg-white p-6">
                            ...
                            {savedMethods.length > 0 && (
                                <div className="mb-4">
                                    <p className="text-base font-medium text-gray-900">Saved bank accounts</p>
                                    ...
                                    <p className="mt-1 text-sm text-gray-600">
                                        You can choose a saved account, or enter a new one, on the
                                        secure payment page.
                                    </p>
                                </div>
                            )}
                            ...
                            <Alert tone="info" className="mb-4" title="How long this takes">
                                Bank payments take 2–5 business days to clear. Your balance will
                                show the payment as processing until then.
                            </Alert>
                            ...
                            <p className="mt-3 text-sm text-gray-600">
                                You will enter your bank details on our payment provider’s secure
