...
return [
	...
	*/
	...
	/*
	 | Only what the address form needs. Timezones, currencies, languages and
	 | geolocation are switched off: each one is another seeded table and
	 | another few megabytes on a shared host, for data nothing reads.
	 |
	 | The application's own timezone handling is App\Support\BusinessCalendar
	 | (D-07), and money is App\Support\Money (I-10) — neither wants a second
	 | source of truth sitting beside it.
	 */
	'modules' => [
		'states' => true,
		'cities' => true,
